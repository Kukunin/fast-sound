...
UNMODIFIED_INDEX=$(OUTPUT_DIR_UNMINIFIED)/index.js
...
$(UNMODIFIED_INDEX):
	echo 'module.exports = require("./fast-sound.js");' > $@
...
$(WHOLE_BUNDLE): $(WHOLE_BUNDLE_ASMJS) $(LIBOPUS_OBJ) $(LIBSPEEXDSP_OBJ) $(UNMODIFIED_INDEX)
	emcc -o $@ $(EMCC_OPTS) $(EMCC_WASM_OPTS) -g3 -s EXPORTED_FUNCTIONS="[$(DEFAULT_EXPORTS),$(LIBOPUS_DECODER_EXPORTS),$(LIBOPUS_ENCODER_EXPORTS),$(LIBSPEEXDSP_EXPORTS)]" $(LIBOPUS_OBJ) $(LIBSPEEXDSP_OBJ) --pre-js src/loader.js
...
$(WHOLE_BUNDLE_MIN): $(LIBOPUS_OBJ) $(LIBSPEEXDSP_OBJ)
	emcc -o $@ $(EMCC_OPTS) $(EMCC_WASM_OPTS) -s EXPORTED_FUNCTIONS="[$(DEFAULT_EXPORTS),$(LIBOPUS_DECODER_EXPORTS),$(LIBOPUS_ENCODER_EXPORTS),$(LIBSPEEXDSP_EXPORTS)]" $(LIBOPUS_OBJ) $(LIBSPEEXDSP_OBJ) --pre-js src/loader.js
